...
from app.api import jira, github, devops, crm, itsm, logs, release_ticket, tag_watcher, tag_promotion, team_contacts, ticket_delivery
...
router.include_router(ticket_delivery.router)
