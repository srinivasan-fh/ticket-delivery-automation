...
> Based on [anboli-foodhub/dev-automation-portal](https://github.com/anboli-foodhub/dev-automation-portal), with **Ticket Delivery** added (JIRA Integration → Ticket Delivery, see below). Start everything from the repo root with `./start.sh`.
